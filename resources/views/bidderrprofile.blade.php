	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				<h3 class="margin-bottom-25">About Company <a href="#" class="button gray ripple-effect ico" data-tippy-placement="top" data-tippy="" data-original-title="Edit" style="padding: 5px 8px;"> <i class="fa-solid fa-pen-to-square"></i></a></h3>
			...
			<div class="sidebar-container">
				...
				<div class="sidebar-widget">
					...
					<div class="freelancer-socials margin-top-25">
						<ul>
							<li><a href="#" data-tippy-placement="top" data-tippy="" data-original-title="Dribbble"><i class="fa-brands fa-dribbble"></i></a></li>
							<li><a href="#" data-tippy-placement="top" data-tippy="" data-original-title="Twitter"><i class="fa-brands fa-twitter"></i></a></li>
							<li><a href="#" data-tippy-placement="top" data-tippy="" data-original-title="Behance"><i class="fa-brands fa-facebook-f"></i></a></li>
							<li><a href="#" data-tippy-placement="top" data-tippy="" data-original-title="GitHub"><i class="fa-brands fa-github"></i></a></li>
					...
					<div class="share-buttons margin-top-25">
						...
						<div class="share-buttons-content">
							...
							<ul class="share-buttons-icons">
								<li><a href="#" data-button-color="#3b5998" data-tippy-placement="top" data-tippy="" data-original-title="Share on Facebook" style="background-color: rgb(59, 89, 152);"><i class="fa-brands fa-facebook-f"></i></a></li>
								<li><a href="#" data-button-color="#1da1f2" data-tippy-placement="top" data-tippy="" data-original-title="Share on Twitter" style="background-color: rgb(29, 161, 242);"><i class="fa-brands fa-twitter"></i></a></li>
								<li><a href="#" data-button-color="#dd4b39" data-tippy-placement="top" data-tippy="" data-original-title="Share on Google Plus" style="background-color: rgb(221, 75, 57);"><i class="fa-brands fa-google-plus-g"></i></a></li>
								<li><a href="#" data-button-color="#0077b5" data-tippy-placement="top" data-tippy="" data-original-title="Share on LinkedIn" style="background-color: rgb(0, 119, 181);"><i class="fa-brands fa-linkedin-in"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
