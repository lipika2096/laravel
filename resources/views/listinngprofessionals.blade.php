		...
		<div class="col-xl-3 col-lg-4">
			<div class="sidebar-container">
				...
				<div class="sidebar-widget">
					...
					<!-- Range Slider -->
					<div class="slider slider-horizontal" id=""></div><input class="range-slider" type="text" value="10,250" data-slider-currency="$" data-slider-min="10" data-slider-max="250" data-slider-step="5" data-slider-value="[10,250]" data-value="10,250" style="display: none;">
				</div>
			...
			<div class="freelancers-container freelancers-list-layout compact-list margin-top-35">
				...
				<div class="freelancer">
					...
					<div class="freelancer-overview">
						<div class="freelancer-overview-inner">
							...
							<div class="freelancer-name">
								<h4><a href="#">Tom Smith <img class="flag" src="images/flags/gb.svg" alt="" data-tippy-placement="top" data-tippy="" data-original-title="United Kingdom"></a></h4>
								<span>UI/UX Designer</span>
								<div><span class="freelancer-detail-item"><a href="#"><i class="fa-solid fa-envelope"></i>david@example.com</a></span>
								<span class="freelancer-detail-item"><i class="fa-solid fa-phone"></i> (+421) 123-456-789</span>
								<span class="freelancer-detail-item"><i class="fa-solid fa-location-dot"></i>auckland,New Zealand</span></div>
								<!-- Rating -->
					...
					<div class="freelancer-details">
						...
						<a href="https://webhosting.busybanda.com/Prime_Professional_Portal/bidderrprofile.html" class="button button-sliding-icon ripple-effect" style="width: 190px;">View Profile <i class="icon-material-outline-arrow-right-alt"></i></a>
					</div>
				</div>
				<!-- Freelancer / End -->
